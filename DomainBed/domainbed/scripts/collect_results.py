...
def print_results_tables(records, task, selection_method, latex):
    ...
    grouped_records = reporting.get_grouped_records(records,
                                                    group_test_envs=(task != "unsupervised_domain_generalization")).map(
        lambda group:
...
if __name__ == "__main__":
    ...
    if args.task == "unsupervised_domain_generalization":
        SELECTION_METHODS = [model_selection.AverageTargetSelectionMethod,
                             model_selection.AverageAllValidSelectionMethod]
    else:
        SELECTION_METHODS = [
            model_selection.IIDAccuracySelectionMethod,
            model_selection.ValidSourceLossSelectionMethod,
    ...
    for selection_method in SELECTION_METHODS:
        ...
        print_results_tables(records, args.task, selection_method, args.latex)
