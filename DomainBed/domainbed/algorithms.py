...
# Include CAD
ALGORITHMS += ['CAD', 'CondCAD']

# Include CLIP algorithms
from domainbed.clip_algorithms import *
ALGORITHMS += CLIP_ALGORITHMS
...
class AbstractBN(Algorithm):
    """Bottleneck (abstract class)"""

    def __init__(self, input_shape, num_classes, num_domains,
                 hparams, bottleneck_class):
        super(AbstractBN, self).__init__(input_shape, num_classes, num_domains, hparams)
        ...
        self.bottleneck = bottleneck_class(self.featurizer.n_outputs, num_classes, num_domains, hparams)
    ...
    def update(self, minibatches, unlabeled=None):
        ...
        clf_out = self.classifier(all_z_hat)
...
class CAD(AbstractBN):
    def __init__(self, feature_dim, num_classes, num_domains, hparams):
        super(CAD, self).__init__(feature_dim, num_classes, num_domains, hparams, CADBottleneck)


class CondCAD(AbstractBN):
    def __init__(self, feature_dim, num_classes, num_domains, hparams):
        super(CondCAD, self).__init__(feature_dim, num_classes, num_domains, hparams, CondCADBottleneck)
